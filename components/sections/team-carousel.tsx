...
const teamMembers = [
  ...
  },
  {
    ...
    position: "International Law Expert",
    image: "/images/person-headshot.png",
    ...
    <section className="py-16 bg-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4" style={{ color: "#643F2E" }}>
            Our Team
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Meet our experienced legal professionals dedicated to providing exceptional legal services and achieving the
                ...
                <div key={member.id} className="w-1/3 flex-shrink-0 px-4">
                  <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-6 text-center">
                      <h3 className="text-xl font-semibold mb-2" style={{ color: "#643F2E" }}>
                        {member.name}
                      </h3>
